...
namespace VoltSwap.BusinessLayer.Services
{
    public class SubscriptionService : BaseService, ISubscriptionService
    {
        ...
        public async Task<ServiceResult> RegisterNewPlanAsync(RegisterNewPlanRequest requestDto)
        {
            ...
            var generateSubId = await _transService.GenerateSubscriptionId();
            ...
            var generateTransContext = await _transService.GenerateTransactionConext(getTransactionContext);
            ...
            var createDeposit = await _transService.CreateTransactionAsync(getDepositTrans);
            var createNewPlanTransaction = await _transService.CreateTransactionAsync(getNewPlanTransaction);
            ...
            var result = await _transService.GetUserTransactionHistoryAsync(requestDto.DriverId.UserId);
