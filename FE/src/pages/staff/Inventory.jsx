...
export default function Inventory() {
  ...
  const buildGridFromApi = (list) => {
    ...
    if (list.length > 20) {
      console.warn(
        `[Inventory] API returned ${list.length} items; using first 20.`
      );
    }
    ...
    <section>
      ...
      <section className="card card-padded mt-4">
        ...
        <div
          ...
          role="grid"
          aria-label="Danh sách Pin trong kho"
        >
            ...
            ({ slot, battery }) => {
              ...
              return (
                <button
                  ...
                  aria-label={
                    battery ? `Pin ${battery.id}, SOC ${pct}%` : "Ô trống"
                  }
                  type="button"
                >
